""" Simple grpc client
Run from Ch05 folder with python3 client_main.py
"""

from client.events import rand_events
...
class Client:
    ...
    def track(self, events):
        """ Tracks the ride """
        self.stub.Track(self.track_request(event) for event in events)
...
# Run from Ch05 with: python3 client_main.py
#
# = = = = = = = = = =
#
#
